...
function SewingMachineModel({ position, rotation, scale }: Props) {
  ...
  const { nodes, materials, animations } = useGLTF("/3DModel/ForSiteSweingMachine1012.glb") as unknown as GLTFResult;
    ...
    <group ref={ref} scale={scale} dispose={null}>
      <group name="Scene">
        ...
        <group name="Cylinder_010" position={[-0.115, 0.006, -0.001]} rotation={[0, 0.737, 0]}>
          ...
          <mesh name="Cylinder_008" geometry={nodes.Cylinder_008.geometry} material={materials['Plastic.002']} />
        ...
        <group name="Cube_002">
          <mesh name="Cube_002001" geometry={nodes.Cube_002001.geometry} material={materials['Base_Plastic_001.001']} />
          <mesh name="Cube_002001_1" geometry={nodes.Cube_002001_1.geometry} material={materials['Material_006.001']} />
          <mesh name="Cube_002001_2" geometry={nodes.Cube_002001_2.geometry} material={materials['Golden.002']} />
        </group>
        <mesh name="Cube_016" geometry={nodes.Cube_016.geometry} material={materials['Base_Plastic_001.001']} />
        <mesh name="Cube_019" geometry={nodes.Cube_019.geometry} material={materials['Black.003']} />
        <mesh name="Cube_020" geometry={nodes.Cube_020.geometry} material={materials['Black.003']} />
        <group name="Cube_021" position={[0.117, 0.127, -0.029]} scale={0.009}>
          <mesh name="Cube_021_1" geometry={nodes.Cube_021_1.geometry} material={materials['Base_Plastic_001.001']} />
        ...
        <group name="Cube_031" position={[0, -0.001, 0]}>
          <mesh name="Cube_031_1" geometry={nodes.Cube_031_1.geometry} material={materials['Material_008.001']} />
          <mesh name="Cube_031_2" geometry={nodes.Cube_031_2.geometry} material={materials['Material_007.001']} />
        </group>
        <mesh name="Cube_032" geometry={nodes.Cube_032.geometry} material={materials['Metal.002']} position={[0, -0.001, 0]} />
        <mesh name="Cube_047" geometry={nodes.Cube_047.geometry} material={materials['Black.003']} />
        <mesh name="Cylinder002" geometry={nodes.Cylinder002.geometry} material={materials['Material_010.001']} position={[0.084, 0.051, 0.055]} rotation={[Math.PI / 2, 0, 0]} />
        <mesh name="Cylinder_003" geometry={nodes.Cylinder_003.geometry} material={materials['Base_Plastic_001.001']} position={[0.161, 0.075, -0.005]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={1.135} />
        ...
        <mesh name="Cylinder_015" geometry={nodes.Cylinder_015.geometry} material={materials['Plastic.002']} />
        ...
        <mesh name="Cylinder_029" geometry={nodes.Cylinder_029.geometry} material={materials['Material_009.001']} position={[-0.086, 0.02, 0.037]} rotation={[Math.PI / 2, 0, 0]} scale={0.415} />
        <group name="Plane007" position={[0.134, 0.134, -0.01]} scale={0.467}>
          ...
          <mesh name="Plane016_1" geometry={nodes.Plane016_1.geometry} material={materials['Plastic.002']} />
        </group>
        ...
        <group name="Plane_006" position={[0, 0.053, -0.014]}>
          ...
          <mesh name="Plane_006_2" geometry={nodes.Plane_006_2.geometry} material={materials['Material_012.001']} />
        </group>
        ...
        <mesh name="Plane_012" geometry={nodes.Plane_012.geometry} material={materials['Black_001.001']} />
        <mesh name="Plane_013" geometry={nodes.Plane_013.geometry} material={materials['Plastic.002']} position={[-0.08, 0.007, -0.027]} rotation={[1.562, 0.152, -0.024]} scale={[0.533, 1.102, 1.102]} />
        <mesh name="Plane_015" geometry={nodes.Plane_015.geometry} material={nodes.Plane_015.material} />
        <mesh name="Curve_008" geometry={nodes.Curve_008.geometry} material={materials.SVGMat_003} position={[-0.012, 0.098, 0.056]} rotation={[1.416, 0, 0.007]} scale={2.007} />
        <mesh name="Curve_019" geometry={nodes.Curve_019.geometry} material={materials.SVGMat_003} position={[0.137, -0.058, 0.066]} rotation={[1.599, -0.001, -0.02]} scale={0.619} />
        <mesh name="Text_001" geometry={nodes.Text_001.geometry} material={materials.Material_007} position={[0.063, -0.087, 0.066]} rotation={[Math.PI / 2, 0, 0]} scale={[0.927, 0.927, 0.756]} />
      </group>
    </group>
  );
}
